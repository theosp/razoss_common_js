...
a){if(!this.RazossBrowser)throw"Browser Not Supported";return window.external.rapi_RegisterEvent(b,a)},unregisterEvent:function(b){if(!this.RazossBrowser)throw"Browser Not Supported";return window.external.rapi_UnregisterEvent(b)},navigate:function(b){if(!this.RazossBrowser)throw"Browser Not Supported";window.external.rapi_Navigate(b)},getCurrentPage:function(){if(!this.RazossBrowser)throw"Browser Not Supported";return window.external.rapi_GetCurrentURL()},getCurrentTitle:function(){if(!this.RazossBrowser)throw"Browser Not Supported";
return window.external.rapi_GetCurrentTitle()},getPageKeywords:function(b){if(!this.RazossBrowser)throw"Browser Not Supported";return window.external.rapi_GetPageKeywords(b)},getCurrentMetadata:function(b){if(!this.RazossBrowser)throw"Browser Not Supported";return window.external.rapi_GetCurrentMetadata(b)},getEngineVariable:function(b){if(!this.RazossBrowser)throw"Browser Not Supported";return window.external.rapi_GetEngineVariable(b)},setNewWindowBehavior:function(b,a){if(!this.RazossBrowser)throw"Browser Not Supported";
window.external.rapi_SetNewWindowBehavior(b,a)},postPageInfo:function(b,a){if(!this.RazossBrowser)throw"Browser Not Supported";return window.external.rapi_PostPageInfo(b,a)},postPageInfoAsync:function(){if(!this.RazossBrowser)throw"Browser Not Supported";},newWindow:function(b,a,c){if(!this.RazossBrowser)throw"Browser Not Supported";return window.external.rapi_NewWindow(b,a,c)},closeWindow:function(b){if(!this.RazossBrowser)throw"Browser Not Supported";return window.external.rapi_CloseWindow(b)},
getCurrentSize:function(){if(!this.RazossBrowser)throw"Browser Not Supported";var b=-1,a=-1;try{b=window.external.rapi_GetCurrentWidth();a=window.external.rapi_GetCurrentHeight()}catch(c){b=a=-1}return{width:b,height:a}},dock:function(b){if(!this.RazossBrowser)throw"Browser Not Supported";window.external.rapi_Dock(b)},dockEx:function(){if(!this.RazossBrowser)throw"Browser Not Supported";window.external.rapi_Dock(pos)},resize:function(b,a,c){if(!this.RazossBrowser)throw"Browser Not Supported";if(c==
undefined)c=true;window.external.rapi_Resize(b,a,c)},resizeKeepPosition:function(b,a,c){if(!this.RazossBrowser)throw"Browser Not Supported";window.external.rapi_Resize(b,a,c)},show:function(b){if(!this.RazossBrowser)throw"Browser Not Supported";window.external.rapi_Show(b)},isVisible:function(){if(!this.RazossBrowser)throw"Browser Not Supported";return window.external.rapi_IsVisible()},close:function(){if(!this.RazossBrowser)throw"Browser Not Supported";return window.external.rapi_Close()},closeAllButThis:function(){if(!this.RazossBrowser)throw"Browser Not Supported";
...
window.external.rapi_SetOpacity(b)},getOpacity:function(){if(!this.RazossBrowser)throw"Browser Not Supported";return window.external.rapi_GetOpacity()},moveWindow:function(b,a,c){if(!this.RazossBrowser)throw"Browser Not Supported";window.external.rapi_MoveWindow(b,a,c)}};rgw.onLoad();
