...
function(a){this.environment==="razoss_browser"?rgw.navigate(a):window.open(a);return this};b.RazossApi.prototype.printScreen=function(){return this.environment==="razoss_browser"?"http://www.razoss.com/alpha/app/thumbs/"+rgw.postPageInfo("www.razoss.com","/razoss_services/razoss_uploader.php"):""};b.RazossApi.prototype.getWindowUrl=function(){return this.environment==="razoss_browser"?rgw.getCurrentPage():""};b.RazossApi.prototype.getWindowTitle=function(){return this.environment==="razoss_browser"?
rgw.getCurrentTitle():""};b.RazossApi.prototype.getWindowDescription=function(){return this.environment==="razoss_browser"?rgw.getCurrentMetadata("description"):""};b.RazossApi.prototype.setIframeLinksTarget=function(a,c){if(this.environment==="razoss_browser")if(typeof a!=="undefined"){if(typeof c==="undefined")c="default";c in this.iframe_links_targets||(c="default");rgw.setNewWindowBehavior(a,NewWindowBehavior[this.iframe_links_targets[c]])}};b.RazossApi.prototype.dock=function(a,c){if(this.environment===
...
0]};RAZOSS_API=new b.RazossApi;RAZOSS_API.listeners={};RAZOSS_API.getEventName=function(a){return"razoss_event_"+a};RAZOSS_API.newRazossEventListener=function(a){var c=this;if(c.environment==="razoss_browser")if(typeof RAZOSS_API.listeners[a]==="undefined"){window[c.getEventName(a)]=function(){var d=Array.prototype.slice.call(arguments);d.unshift(c.getEventName(a));RAZOSS_API.emit.apply(c,d)};rgw.registerEvent(a,c.getEventName(a))}};RAZOSS_API.onRazossEvent=function(a,c){this.newRazossEventListener(a);
this.on(this.getEventName(a),c)};RAZOSS_API.onceRazossEvent=function(a,c){this.newRazossEventListener(a);this.once(this.getEventName(a),c)};RAZOSS_API.removeRazossEventListener=function(a,c){this.newRazossEventListener(a);this.removeListener(this.getEventName(a),c)};RAZOSS_API.removeAllListeners=function(a){this.newRazossEventListener(a);this.removeListener(this.getEventName(a))}})(jQuery);
