...
(function(b){b.RazossApi=function(a){if(typeof a==="undefined")a={};this.options=theosp.object.clone(this.options);b.extend(this.options,a);this.environment=null;this.init()};b.RazossApi.prototype=new EventEmitter;b.RazossApi.prototype.constructor=b.RazossApi;b.RazossApi.prototype.options={};b.RazossApi.prototype.iframe_links_targets={"default":"defaultBehavior",popup:"razossPopup",current:"hostCurrentTab",new_tab:"hostNewTab"};b.RazossApi.prototype.$=function(a,c){a=theosp.string.supplant(a,{prefix:this.options.css_prefix});
return b(a,c)};b.RazossApi.prototype.init=function(){this.environment=rgw.RazossBrowser?"razoss_browser":typeof GM_log!=="undefined"?"greasemonkey":"direct_view";var a=this.getHostBrowser();b("html").addClass("host_browser-"+a[0])};b.RazossApi.prototype.getUid=function(){return this.environment==="razoss_browser"?rgw.getEngineVariable("engineid"):null};b.RazossApi.prototype.version=function(){return this.environment==="razoss_browser"?rgw.getEngineVariable("engineversion"):"plugin_mode"};b.RazossApi.prototype.openUrl=
function(a){this.environment==="razoss_browser"?rgw.navigate(a):window.open(a);return this};b.RazossApi.prototype.printScreen=function(){return this.environment==="razoss_browser"?"http://www.razoss.com/alpha/app/thumbs/"+rgw.postPageInfo("www.razoss.com","/razoss_services/razoss_uploader.php"):""};b.RazossApi.prototype.getWindowUrl=function(){return this.environment==="razoss_browser"?rgw.getCurrentPage():"http://www.razoss.com/"};b.RazossApi.prototype.getWindowTitle=function(){return this.environment===
"razoss_browser"?rgw.getCurrentTitle():"Razoss"};b.RazossApi.prototype.getWindowDescription=function(){return this.environment==="razoss_browser"?rgw.getCurrentMetadata("description"):""};b.RazossApi.prototype.setIframeLinksTarget=function(a,c){if(this.environment==="razoss_browser")if(typeof a!=="undefined"){if(typeof c==="undefined")c="default";c in this.iframe_links_targets||(c="default");rgw.setNewWindowBehavior(a,NewWindowBehavior[this.iframe_links_targets[c]])}};b.RazossApi.prototype.dock=function(a,
c){if(this.environment==="razoss_browser"){rgw.dock(HPosition[a]|VPosition[c]);document.body.style.backgroundColor=rgw.getTrasparentColor();rgw.setOpacity(255)}};b.RazossApi.prototype.getHostBrowser=function(){if(this.environment==="razoss_browser"){var a=rgw.getEngineVariable("hostbrowser").toLowerCase();a=/(webkit)[ \/]([\w.]+)/.exec(a)||/(opera)(?:.*version)?[ \/]([\w.]+)/.exec(a)||/(msie) ([\w.]+)/.exec(a)||!/compatible/.test(a)&&/(mozilla)(?:.*? rv:([\w.]+))?/.exec(a)||[];if(a[1]==="msie")a[1]=
"ie";return[a[1],a[2]]}else return["direct",0]};RAZOSS_API=new b.RazossApi;RAZOSS_API.listeners={};RAZOSS_API.getEventName=function(a){return"razoss_event_"+a};RAZOSS_API.newRazossEventListener=function(a){var c=this;if(c.environment==="razoss_browser")if(typeof RAZOSS_API.listeners[a]==="undefined"){window[c.getEventName(a)]=function(){var d=Array.prototype.slice.call(arguments);d.unshift(c.getEventName(a));RAZOSS_API.emit.apply(c,d)};rgw.registerEvent(a,c.getEventName(a))}};RAZOSS_API.onRazossEvent=
function(a,c){this.newRazossEventListener(a);this.on(this.getEventName(a),c)};RAZOSS_API.onceRazossEvent=function(a,c){this.newRazossEventListener(a);this.once(this.getEventName(a),c)};RAZOSS_API.removeRazossEventListener=function(a,c){this.newRazossEventListener(a);this.removeListener(this.getEventName(a),c)};RAZOSS_API.removeAllListeners=function(a){this.newRazossEventListener(a);this.removeListener(this.getEventName(a))}})(jQuery);
